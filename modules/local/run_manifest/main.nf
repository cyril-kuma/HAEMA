process BUILD_RUN_MANIFEST {
    ...
    def parameters = [
        ...
        remote_blast_db: params.remote_blast_db,
        blast_db_mount: params.blast_db_mount,
        enable_curated_panel_check: params.enable_curated_panel_check,
        enable_ncbi_remote_fallback: params.enable_ncbi_remote_fallback,
        enable_bold_fallback: params.enable_bold_fallback,
        bold_mode: params.bold_mode,
        bold_fasta: params.bold_fasta,
        bold_taxonomy: params.bold_taxonomy,
        coi_species_identity_threshold: params.coi_species_identity_threshold,
        cytb_species_identity_threshold: params.cytb_species_identity_threshold,
        marker_numt_risk: params.marker_numt_risk,
